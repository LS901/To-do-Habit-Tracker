    ...
    return (
        ...
        <div className='sidebar-wrapper h-[100%] border-r-2 p-6 rounded-lg flex flex-row bg-gradient-to-r from-gray-600 to-gray-800'>
            <div className='flex flex-row items-center'>
                ...
                <h1 className='px-3 text-gray-300 font-extrabold/20 text-2xl '>My List</h1>
            </div>
            <div className='flex items-center mx-auto'>
                <img className='w-16 h-16' src='public/tick2.png'></img>
            </div>
            <motion.div className='task-manager flex flex-row items-center '
